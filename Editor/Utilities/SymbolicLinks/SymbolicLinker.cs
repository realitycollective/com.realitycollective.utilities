...
namespace RealityToolkit.Editor.Utilities.SymbolicLinks
{
    ...
    public static class SymbolicLinker
    {
        ...
        public static SymbolicLinkSettings Settings
        {
            ...
            {
                if (settings == null &&
                    !string.IsNullOrEmpty(ToolkitPreferences.SymbolicLinkSettingsPath))
                {
                    if (DebugEnabled)
                    {
                        Debug.Log($"Loading symlink settings from :{ToolkitPreferences.SymbolicLinkSettingsPath}");
                    }

                    settings = AssetDatabase.LoadAssetAtPath<SymbolicLinkSettings>(ToolkitPreferences.SymbolicLinkSettingsPath);
                }
        ...
        public static void RunSync(bool forceUpdate = false)
        {
            ...
            if (!ToolkitPreferences.AutoLoadSymbolicLinks && !forceUpdate)
            {
                return;
            }
            ...
            if (Settings == null)
            {
                if (!string.IsNullOrEmpty(ToolkitPreferences.SymbolicLinkSettingsPath))
                {
                ...
                ToolkitPreferences.AutoLoadSymbolicLinks = false;
                return;
            }
